"""v49 — BFS + string-pull smoothing (Theta*-style, wall-safe) + waypoint gaze."""
import sys
...
OUT_DIR = "/home/kingy/Projects/Genesis/GenesisTools/results/ai33_001_walkthrough_v49"
...
config = {
    ...
    "num_waypoints": 20,
    "seed": 42,
    "path_planner": "theta_star",       # BFS + string-pull (wall-safe)
    "theta_max_dz": 2,                  # max Z change per LOS shortcut (voxels)
...
print(f"[v49] output -> {OUT_DIR}")
result = run(BLEND, config, OUT_DIR, render=True)
print("[v49] done:", result)
