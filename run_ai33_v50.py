"""v50 — Pure BFS path (no smoothing). Adjacent-voxel steps guarantee no wall crossing."""
import sys
...
OUT_DIR = "/home/kingy/Projects/Genesis/GenesisTools/results/ai33_001_walkthrough_v50"
...
config = {
    ...
    "num_waypoints": 20,
    "seed": 42,
    "path_planner": "theta_star",       # dispatches pure BFS (no smoothing) since v50
...
print(f"[v50] output -> {OUT_DIR}")
result = run(BLEND, config, OUT_DIR, render=True)
print("[v50] done:", result)
