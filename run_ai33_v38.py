"""Run AI33_001_280 walkthrough v38 — LOS-based waypoint orientations + path interpolation."""
import sys
...
OUT_DIR = "/home/kingy/Projects/Genesis/GenesisTools/results/ai33_001_walkthrough_v38"
...
print(f"[v38] output -> {OUT_DIR}")
result = run(BLEND, config, OUT_DIR, render=True)
print("[v38] done:", result)
