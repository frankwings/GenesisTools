"""Run AI33_001_280 walkthrough v39 — waypoint gaze toward future unvisited waypoints."""
import sys
...
OUT_DIR = "/home/kingy/Projects/Genesis/GenesisTools/results/ai33_001_walkthrough_v39"
...
print(f"[v39] output -> {OUT_DIR}")
result = run(BLEND, config, OUT_DIR, render=True)
print("[v39] done:", result)
