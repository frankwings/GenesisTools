"""Run AI33_001_280 walkthrough v41 — aerial mode + XYZ farthest-point sampling."""
import sys
...
OUT_DIR = "/home/kingy/Projects/Genesis/GenesisTools/results/ai33_001_walkthrough_v41"
...
print(f"[v41] output -> {OUT_DIR}")
result = run(BLEND, config, OUT_DIR, render=True)
print("[v41] done:", result)
