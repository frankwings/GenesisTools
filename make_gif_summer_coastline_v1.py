"""Generate walkthrough GIFs for summer_coastline v1 (Phase 1+2)."""
import sys
...
combined_gif_path = ASSETS / "summer_coastline_v1_walkthrough_combined.gif"
make_combined_gif(
    frames=all_frames,
...
mp4_path = ASSETS / "summer_coastline_v1_walkthrough_combined.mp4"
make_combined_mp4(
    frames=all_frames,
    path_npz=RESULTS / "path.npz",
    terrain_npz=RESULTS / "terrain_snake.npz",
