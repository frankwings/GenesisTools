"""v52 — 6-connected BFS + aerial ceiling filter (camera stays below ceiling)."""
import sys
...
OUT_DIR = "/home/kingy/Projects/Genesis/GenesisTools/results/ai33_001_walkthrough_v52"
...
print(f"[v52] output -> {OUT_DIR}")
result = run(BLEND, config, OUT_DIR, render=True)
print("[v52] done:", result)
