"""Run AI33_001_280 walkthrough v42 — aerial mode + XYZ FPS + XYZ TSP."""
import sys
...
OUT_DIR = "/home/kingy/Projects/Genesis/GenesisTools/results/ai33_001_walkthrough_v42"
...
print(f"[v42] output -> {OUT_DIR}")
result = run(BLEND, config, OUT_DIR, render=True)
print("[v42] done:", result)
