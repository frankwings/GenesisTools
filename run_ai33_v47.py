"""v47 — arc-length sampling + waypoint_gaze_mode: lookahead (travel direction)."""
import sys
...
OUT_DIR = "/home/kingy/Projects/Genesis/GenesisTools/results/ai33_001_walkthrough_v47"
...
config = {
    ...
    "num_waypoints": 20,
    "seed": 42,
    "waypoint_gaze_mode": "lookahead",  # ← look in direction of travel
...
print(f"[v47] output -> {OUT_DIR}")
result = run(BLEND, config, OUT_DIR, render=True)
print("[v47] done:", result)
