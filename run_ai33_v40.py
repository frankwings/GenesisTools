"""Run AI33_001_280 walkthrough v40 — aerial mode + Windows WORKBENCH."""
import sys
...
OUT_DIR = "/home/kingy/Projects/Genesis/GenesisTools/results/ai33_001_walkthrough_v40"
...
print(f"[v40] output -> {OUT_DIR}")
result = run(BLEND, config, OUT_DIR, render=True)
print("[v40] done:", result)
