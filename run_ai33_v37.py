"""Run AI33_001_280 walkthrough v37 — walkable step 2 fix: .blend opened for ray_cast."""
import sys
...
OUT_DIR = "/home/kingy/Projects/Genesis/GenesisTools/results/ai33_001_walkthrough_v37"
...
print(f"[v37] output -> {OUT_DIR}")
result = run(BLEND, config, OUT_DIR, render=True)
print("[v37] done:", result)
