"""Run AI33_001_280 walkthrough v45 — voxel centre Z + Laplacian Z clamp."""
import sys
...
OUT_DIR = "/home/kingy/Projects/Genesis/GenesisTools/results/ai33_001_walkthrough_v45"
...
print(f"[v45] output -> {OUT_DIR}")
result = run(BLEND, config, OUT_DIR, render=True)
print("[v45] done:", result)
