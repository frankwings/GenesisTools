"""v46 — arc-length sampling + waypoint_gaze_mode: waypoint (future-WP average gaze)."""
import sys
...
OUT_DIR = "/home/kingy/Projects/Genesis/GenesisTools/results/ai33_001_walkthrough_v46"
...
config = {
    ...
    "num_waypoints": 20,
    "seed": 42,
    "waypoint_gaze_mode": "waypoint",   # ← average of visible future waypoints
...
print(f"[v46] output -> {OUT_DIR}")
result = run(BLEND, config, OUT_DIR, render=True)
print("[v46] done:", result)
