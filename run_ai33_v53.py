"""v53 — 6-connected BFS + aerial ceiling filter (camera stays below ceiling)."""
import sys
...
OUT_DIR = "/home/kingy/Projects/Genesis/GenesisTools/results/ai33_001_walkthrough_v53"
...
print(f"[v53] output -> {OUT_DIR}")
result = run(BLEND, config, OUT_DIR, render=True)
print("[v53] done:", result)
