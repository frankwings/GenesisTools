"""v48 — Theta* any-angle path planner + waypoint gaze mode (compare vs v46 BFS+Laplacian)."""
import sys
...
OUT_DIR = "/home/kingy/Projects/Genesis/GenesisTools/results/ai33_001_walkthrough_v48"
...
config = {
    ...
    "num_waypoints": 20,
    "seed": 42,
    "path_planner": "theta_star",       # ← Theta* replaces BFS + Laplacian
    "waypoint_gaze_mode": "waypoint",   # same as v46 for fair comparison
...
print(f"[v48] output -> {OUT_DIR}")
result = run(BLEND, config, OUT_DIR, render=True)
print("[v48] done:", result)
